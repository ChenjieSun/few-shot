...
print("Depending on the split files, organize train and test sets")
for datatype in ['images_background', 'images_evaluation']:
    ...
    for img_class in classes:
        if os.path.exists(os.path.join(datatype, img_class)):
            continue
        else:
            cur_dir = datatype
